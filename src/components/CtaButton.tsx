...
export default function CtaButton({
  ...
  return (
    <a
      href={href}
      onClick={onClick}
      className={`inline-flex h-[50px] items-center justify-center gap-2.5 whitespace-nowrap rounded-xl px-4 py-4 text-base font-semibold transition-transform hover:scale-[1.02] ${fixedWidth ? "w-[240px]" : "w-fit"} ${look} ${className}`}
    >
      {children}
